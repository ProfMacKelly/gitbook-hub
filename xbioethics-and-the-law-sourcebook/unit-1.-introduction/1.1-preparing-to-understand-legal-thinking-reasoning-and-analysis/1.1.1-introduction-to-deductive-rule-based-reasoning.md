...
![inverted pyramid divided into three parts. The major premise is at the base (i.e., at the top of the inverted pyramid), the minor premise is in the middle, and the conclusion is at the bottom.](<../../../.gitbook/assets/image (17)>)
...
>
> Conclusion: Socrates, Joe's bird, is mortal.

Although the premises and the conclusion may all be true, the syllogism's reasoning is invalid. The premise that Socrates is a bird is incompatible with all men being mortal. Specifically, the argument's reasoning is invalid because the minor premise that "Socrates is a bird" does not fit within the overarching category of "all men are mortal." Here is how this syllogism's reasoning looks visually:

![](<../../../.gitbook/assets/image (2) (1)>)

In this syllogism, the **minor premise** about a bird and the subsequent **conclusion** about the mortality of the bird cannot follow from the **major premise** that all men are mortal. As the diagram's arrows indicate, they must be part of a different funnel. Thus, we can see the invalidity of the syllogism presented. For this **conclusion** to be valid, a **major premise** is required that encompasses birds and mortality, such as "All birds are mortal"; "Joe's bird is mortal"; "Anyone or anything named Socrates is mortal"; etc.
...
Unlike the "some writers" example above, this major premise applies to an entire class. However, even if each part of the syllogism is true, the logic can still be invalid; this "superhero" syllogism is flawed. Stating that all superheroes have a superhuman ability does not mean that superheroes are the only beings with superhuman abilities. So, the premises in this argument lack the facts necessary to logically conclude that Superman is a superhero.
...
Anyone or anything that is mortal is subject to death.
{% endstep %}
...
Those who are mortals are not gods.
{% endstep %}
...
In daily conversations, political arguments, legal reasoning (including judicial opinions), etc., enthymemes are common. For example:
...
* Case law is a type of law written by courts to both interpret codified laws and establish or extend case law (i.e., common law), which we refer to generally as "cases," "opinions," and "decisions." For instance, the U.S. Supreme Court establishes interpretations of constitutional text (through principles of reasonable suspicion and probable cause, stop and frisk, search and seizure, interrogations, etc.), and regularly extends those principles as further applications of those principles become necessary (e.g., exceptions to the warrant requirement, cell phone searches, blood draws, etc.).
{% endhint %}

"Facts" refers to a given set of circumstances, such as the situation an officer finds themselves in (e.g., witnessing suspected criminal activity, establishing probable cause to apply for a search warrant, when or how much force to use, and the behavior of a suspect or inmate).
...
>
> Analysis to Conclusion: Because going through another marriage ceremony recognized by law while already legally married is bigamy, having multiple legal marriages makes Allen guilty of bigamy.
...
>
> Facts (the "variables"): Lucy, a law enforcement officer, arrested Charlie, secured him in a patrol car, and drove him to the police station.
>
...
Section 940.01 of the East Dakota statutes states, "Whoever is guilty of murder if they intentionally cause the death of another human being without a legal justification."
{% endstep %}

{% step %}
### Rule 2 (a "formula")

For murder, "intentional" means that the person acted with the purpose to cause the result.
{% endstep %}

{% step %}
### Rule 3 (a "formula")

The legal justification for murder is self-defense.
{% endstep %}

{% step %}
### Fact 1 (a "variable")

Henry is a human being.
{% endstep %}

{% step %}
### Fact 2 (a "variable")

Evidence from the investigation demonstrated that Joseph shot and killed Henry inside Henry's home.
{% endstep %}

{% step %}
### Fact 3 (a "variable")

Evidence from the investigation demonstrated that before killing Henry, Joseph broke into Henry's home and waited for Henry to return.
{% endstep %}

{% step %}
### Fact 4 (a "variable")

Evidence from the investigation demonstrated Joseph did not act in self-defense at the time he killed Henry.
{% endstep %}
...
>
> Rule: The right of privacy includes a woman's decision whether or not to terminate her pregnancy.
>
...
[![](https://prof-mackelly.gitbook.io/bioethics-and-the-law/~gitbook/image?url=https%3A%2F%2Fchooser-beta.creativecommons.org%2Fimg%2Fcc-logo.f0ab4ebe.svg\&width=40\&dpr=3\&quality=100\&sign=f1d89af2\&sv=2)![](https://prof-mackelly.gitbook.io/bioethics-and-the-law/~gitbook/image?url=https%3A%2F%2Fchooser-beta.creativecommons.org%2Fimg%2Fcc-by.21b728bb.svg\&width=40\&dpr=3\&quality=100\&sign=38e50507\&sv=2)![](https://prof-mackelly.gitbook.io/bioethics-and-the-law/~gitbook/image?url=https%3A%2F%2Fchooser-beta.creativecommons.org%2Fimg%2Fcc-nc.218f18fc.svg\&width=40\&dpr=3\&quality=100\&sign=87a3d1ec\&sv=2)![](https://prof-mackelly.gitbook.io/bioethics-and-the-law/~gitbook/image?url=https%3A%2F%2Fchooser-beta.creativecommons.org%2Fimg%2Fcc-sa.d1572b71.svg\&width=40\&dpr=3\&quality=100\&sign=f18e856f\&sv=2)](https://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1)
