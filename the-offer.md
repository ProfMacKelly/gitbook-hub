...
The offer must demonstrate the **offeror** (the party making the offer) intentionally assents to enter into a mutually binding contract with the **offeree** (the party intended to receive the offer).
...
An offer can be terminated when the offeree rejects it.
{% endstep %}

{% step %}
### Is replaced by a counteroffer

A counteroffer from the offeree terminates the original offer.
{% endstep %}

{% step %}
### Lapses or expires

Unless the offer states a specific time, it remains open for a reasonable time. A **lapsed offer** is one that is no longer valid because a reasonable time to accept it has expired. An expired coupon is an example of a lapsed offer.
{% endstep %}

{% step %}
### Is revoked

The offeror may revoke the offer under applicable rules (revocation is not effective until received by the offeree).
{% endstep %}

{% step %}
### Is terminated by operation of law

Offers may terminate automatically by events such as death or incapacity of the offeror, destruction of the subject matter, or illegality.
{% endstep %}
{% endstepper %}

#### What Is Not an Offer

Before discussing the required elements of a legally effective offer, it is helpful to start with some circumstances that _cannot_ be a legally effective offer:
...
* [Contracts](https://pressbooks.pub/introductiontobusinesslaw/chapter/chapter-10/) in _Fundamentals of Business Law_ by Melissa Randall (2020), used under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).
* [The Offer](https://2012books.lardbucket.org/books/the-legal-environment-and-foundations-of-business-law/s12-02-the-offer.html) in _The Legal Environment and Foundations of Business Law_ by Mayer, D., Warner, D. M., Siedel, G. J., Lieberman, J. K., & Martina, A. R., used under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).
* The definitions of [offeror and offeree](https://www.law.cornell.edu/wex/offeror) are derived or adapted from the [Wex Legal Encyclopedia](https://www.law.cornell.edu/wex) by Cornell Law School Legal Information Institute, under [CC BY-NC-SA 2.5](https://creativecommons.org/licenses/by-nc-sa/2.5).
