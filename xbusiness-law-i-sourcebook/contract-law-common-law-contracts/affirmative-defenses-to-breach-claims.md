...
Illegal contracts are unenforceable because they are void. There are two common types of illegalities: (1) statutory violations, and (2) violations of public policy.
...
If someone lacks the mental capacity to understand the terms of the agreement, there cannot be a true meeting of the minds to form a contract. Capacity is the mental state of mind sufficient to understand that a contract is made and its legal consequences.
...
Unconscionability occurs when the contract contains markedly unfair terms against the party with less bargaining power or sophistication than the party who created the terms and induced the other party to sign it. Common cases involving unconscionability claims occur when one party is an experienced business dealer, while the other party is an average consumer.

If the business dealer uses a very small font and inserts terms into the contract in a way that intentionally misleads the consumer into signing on unfair terms, then the contract may be deemed unconscionable.

#### Statute of Frauds

The Statute of Frauds requires the form of certain contracts to be in writing and signed to be enforceable. The Statute of Frauds originated in England in 1677 to prevent fraud when one party tries to claim a contract existed when it did not. The Statute of Frauds requires a written contract for:

* Real property interests;
* Marriage;
* Payment of another’s debt;
* Contracts that cannot be completely performed within one year;
* Contracts for the sale of goods of five hundred dollars or more; and
* Acting as another’s executor/administrator.
...
* Except where otherwise noted, this page's content is adapted from Defenses to Contracts (https://pressbooks.pub/introductiontobusinesslaw/chapter/chapter-10/) in Fundamentals of Business Law (https://pressbooks.pub/introductiontobusinesslaw/) by Melissa Randall (2020), used under CC BY-NC-SA 4.0 (https://creativecommons.org/licenses/by-nc-sa/4.0/).
* The definition of affirmative defense (https://www.law.cornell.edu/wex/affirmative\_defense) is derived or otherwise adapted from the Wex Legal Encyclopedia (https://www.law.cornell.edu/wex) by Cornell Law School Legal Information Institute, under CC BY-NC-SA 2.5 (https://creativecommons.org/licenses/by-nc-sa/2.5/).
